...
@:keep @:bind #if display private #end class __ASSET__assets_data_tower_oep extends null { }
...
@:keep @:bind #if display private #end class __ASSET__assets_map_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/map.png") #if display private #end class __ASSET__assets_map_png extends lime.graphics.Image {}
